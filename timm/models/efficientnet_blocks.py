...
from .layers.adaptive_avgmax_pool import MaxAvgPool
from .layers.padding import get_padding
...
class PoolingConv(nn.Module):
    ...
    def __init__(self, in_chs, out_chs, dw_kernel_size=3,
        ...
        self.conv_dw = MaxAvgPool(dw_kernel_size, stride=stride, padding=padding)
        self.bn2 = norm_layer(mid_chs, **norm_kwargs)
        self.act2 = act_layer(inplace=True)
